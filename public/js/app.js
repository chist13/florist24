...
exports.default = [{
	...
	component: function component(resolve) {
		return __webpack_require__.e/* require */(0).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(218)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe);
	}
}];
...
var _vueClassComponent = __webpack_require__(79);
...
var _animatable = __webpack_require__(243);

var _animatable2 = _interopRequireDefault(_animatable);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Home = (_dec = (0, _vueClassComponent2.default)({
    mixins: [_animatable2.default]
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(13)(Function.call, __webpack_require__(75).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
var _vueSnotify = __webpack_require__(156);
...
var _vueNavTabs = __webpack_require__(158);
...
var _vuetable = __webpack_require__(160);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(47), __webpack_require__(49)))
...
var _MyModal = __webpack_require__(165);
 ...
 * components
 */
_vue2.default.component('my-modal', _MyModal2.default);
...
Component.options.__file = "resources/assets/js/shared/components/MyModal.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-829c6968", Component.options)
  } else {
    hotAPI.reload("data-v-829c6968", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-829c6968", module.exports)
  }
}
...
var MyTable = (_dec = (0, _vueClassComponent2.default)({
    ...
    function MyTable() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = MyTable.__proto__ || (0, _getPrototypeOf2.default)(MyTable)).call.apply(_ref, [this].concat(args))), _this), _this.count = 0, _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
    }
    ...
    (0, _createClass3.default)(MyTable, [{
        ...
        get: function get() {
            return this.fields.map(function (e) {
                return typeof e === 'string' ? { title: e.charAt(0).toUpperCase() + e.slice(1), name: e } : e;
            });
        }
    }, {
        key: 'tableData',
      ...
      _c("thead", [
        _c(
          ...
          _vm._l(_vm.tableFields, function(field) {
            return _c("th", [_vm._v(_vm._s(field.title))])
          })
        )
      ]),
      _vm._v(" "),
              ...
              return _c(
                ...
                [
                  field.name.startsWith("__slot:")
                    ? [_vm._t(field.name.split(":")[1], null, { item: item })]
...
var _functions = __webpack_require__(82);
...
exports.default = {
    ...
    mounted: function mounted() {
        ...
        this.$event.$on('navigation:minimalize', function (n) {
            return _this.toggle();
        });
    },

    watch: {
        isMini: function isMini(old, value) {
            document.body.classList[value ? 'remove' : 'add']('mini-navbar');
        }
    },
    components: {
        'navigation-header': __webpack_require__(194),
        'navigation-dropdown': __webpack_require__(198)
    },
    methods: {
...
var _clients = __webpack_require__(206);
...
var _getters = __webpack_require__(212);

var _getters2 = _interopRequireDefault(_getters);

var _mutations = __webpack_require__(213);

var _mutations2 = _interopRequireDefault(_mutations);

var _state = __webpack_require__(215);
...
var _ClientTransformer = __webpack_require__(208);

var _ClientTransformer2 = _interopRequireDefault(_ClientTransformer);

var _mutationTypes = __webpack_require__(78);

var types = _interopRequireWildcard(_mutationTypes);

var _clientProxy = __webpack_require__(210);
...
exports.default = {
    all: function all(_ref) {
        ...
        return new _clientProxy2.default().all().then(function (res) {
...
var _Transformer2 = __webpack_require__(209);
...
var _Proxy2 = __webpack_require__(211);
...
var _defineProperty2 = __webpack_require__(214);
...
var Animation = (_temp = _class = function () {
    function Animation(node, name) {
    ...
    (0, _createClass3.default)(Animation, [{
        ...
        value: function start() {
            ...
            Animation.eventNames.map(function (eventName) {
                var func = function func(e) {
                    _this.handler(e);

                    _this.node.removeEventListener(eventName, func);
                };

                _this.node.addEventListener(eventName, func);
            });
        }
    }, {
        key: 'pause',
        ...
        value: function stop() {
            ...
            Animation.eventNames.map(function (eventName) {
                _this2.node.addEventListener(eventName, func);
            });
        }
    }, {
        key: 'handler',
    ...
    return Animation;
}(), _class.eventNames = ['webkitAnimationEnd', 'mozAnimationEnd', 'MSAnimationEnd', 'oanimationend', 'animationend'], _temp);
exports.default = {
    methods: {
        animate: function animate(node, name) {
            var animation = new Animation(node, name);
